...
import { Button, Tag, Card, Row, Col, Typography, Divider, Modal, Space, Spin } from "antd";
...
function JobDetails() {
  ...
  const hdCancel = () => setIsModalOpen(false);
  ...
  if (!data) return <Spin tip="Đang tải dữ liệu..." fullscreen />;
    ...
    <>
      ...
      <div style={{ padding: "24px", flex: 1 }}>
        ...
        <Row justify="space-between" align="middle">
          <Col>
            ...
            <Text type="secondary">
              ...
              {dayjs(data.expiryAt).format("DD/MM/YYYY")}
            </Text>
          </Col>
          <Col>
        ...
        <Card>
          ...
          <p>
            <strong>Tên công ty:</strong> {data.inforCompany?.companyName}
          </p>
          <p>
            <strong>Địa chỉ:</strong> {data.inforCompany?.address}
          </p>
          <p>
            <strong>Website:</strong>{" "}
            <a href={data.inforCompany?.website} target="_blank" rel="noreferrer">
              {data.inforCompany?.website}
            </a>
          </p>
          <p>
            <strong>Quy mô:</strong> {data.inforCompany?.quantityPeople} nhân viên
          </p>
